...
The URL must be considered valid by the [redirect callback handler](https://next-auth.js.org/configuration/callbacks#redirect-callback). By default it requires the URL to be an absolute URL at the same hostname, or else it will redirect to the homepage. You can define your own [redirect callback](https://next-auth.js.org/configuration/callbacks#redirect-callback) to allow other URLs, including supporting relative URLs.
...
The URL must be considered valid by the [redirect callback handler](https://next-auth.js.org/configuration/callbacks#redirect-callback). By default this means it must be an absolute URL at the same hostname (or else it will default to the homepage); you can define your own custom [redirect callback](https://next-auth.js.org/configuration/callbacks#redirect-callback) to allow other URLs, including supporting relative URLs.
